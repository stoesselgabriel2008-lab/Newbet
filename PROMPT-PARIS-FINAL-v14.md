# 🎯 Prompt quotidien — Paris sportifs **v14**
...
>
> *Ce qui change vs v13, en quatre points : (1) une **boîte à réflexion** visible où le modèle raisonne comme un vrai passionné et **tue les picks bancals** avant de committer ; (2) un **gate de cohérence** (chaque pari découle du raisonnement, zéro orphelin) + un **gate de bon sens** (marché offensif → le côté qui a le plus de chances de marquer) ; (3) un **conseil de révision** à 3 lentilles ; (4) recherche **par match** renforcée. Tout le moteur de v13 est conservé — juste plus intelligent et plus tranchant.*
...
6. Chaque 🟢 : proba ajustée cohérente avec le dévig (déplacement tracé + facteur), EV au-dessus du seuil (sur l'EV), survit au ±2 pts (deux bornes) ? La part d'edge venant de l'écart Betclic-vs-ancre est-elle distinguée de l'ajustement tactique (pas de double-comptage, règle 8) ?
